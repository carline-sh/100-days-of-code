    ...
    <div>
      <div className="text-white p-4 space-y-4 mx-auto w-full max-w-2xl">
        ...
        <div className="flex gap-2 justify-center py-4 border border-neutral-700 rounded-sm">
          <div className="px-2 py-1 w-14 h-14 bg-neutral-200 rounded-sm text-black flex justify-center items-center">
            w-14
          </div>
          <div className="px-2 py-1 w-14 h-14 bg-neutral-200 rounded-sm text-black flex justify-center items-center">
            h-14
        ...
        <div className="bg-blue-600 w-full rounded-md p-4 flex items-center justify-center">
          <div className="bg-blue-400 w-42 h-20 rounded-md flex border">
            <div className="grow flex items-center justify-center">
              <p className="pb-1 flex items-center justify-center">content</p>
            </div>
            <div className="h-full w-12 bg-blue-100 rounded-r-md text-blue-400 flex items-center justify-center">
              <div className="pb-1 flex items-center justify-center">pr-4</div>
            </div>
          </div>
        </div>
