...
export function Blog() {
  return (
    <div className="">
      <div className="flex justify-center items-center p-2 bg-linear-to-b from-orange-200 to-orange-400 text-neutral-800 text-lg max-w-4xl w-full mx-auto border md:border-t-0 comic-relief-regular">
